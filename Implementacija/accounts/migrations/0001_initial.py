    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idigra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.igra')),
                ...
                ('idrec', models.ForeignKey(default=-1, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_idrec+', to='accounts.rec')),
            ],
            options={
                'db_table': 'potez',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idigra', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='accounts.igra')),
                ('first_turn', models.IntegerField(default=0)),
